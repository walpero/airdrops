...
const NotificationService: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      ...
      {isOpen && (
        <div className="absolute bottom-full right-0 mb-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4">
          {error && (
          ...
          <div className="space-y-4">
            ...
            <a
              ...
              className="block w-full px-4 py-2 text-center text-indigo-600 bg-indigo-100 rounded-lg hover:bg-indigo-200"
            >
              RSS Feed
            </a>
          </div>
